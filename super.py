...
-------------------------------------------------------
super.py
application file that creates a single copy of a mock exam
-------------------------------------------------------
...
#CHAPTER 30-32, 35 = 40%
print("""
---------------Welcome to The EC140 Exam Generator----------------------
    - Not for sale
...
fv = open('{}.txt'.format(FILE_TO_WRITE_TO),'w+',encoding='utf-8')
...
CH19_22_PERC = int(QUESTIONS_AMOUNT * .2)
CH23_26_PERC = int(QUESTIONS_AMOUNT *.2)
CH26_29_PERC = int(QUESTIONS_AMOUNT *.2)
CH30_32_35_PERC = int(QUESTIONS_AMOUNT * .4)
...
for k in file_questions:
    ...
    #print("{}".format(k.chapter),file=fv)
    print("""
    """,file=fv)
    count+=1
print("""
